...
var ASG_DEFAULTS = {
  suffixTemplate:
    "\n\n---\nThe user is using **Caliber** (a browser extension) to request stricter honesty in your reply. Apply everything below.\n\n" +
  ...
  selfGradeTemplate:
    "The user sent this via **Caliber** (a browser extension) to audit your last reply.\n\n" +
  ...
  mediaCheckTemplate:
    "\n\n---\n**Caliber — media / file check** (answer this first, before anything else):\n" +
